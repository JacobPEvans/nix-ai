# Gemini Components
#
# Manages skills and custom commands for Gemini CLI.
# Skills are deployed to both ~/.gemini/skills/ and ~/.agents/skills/ (cross-tool alias).
...
let
  ...
  mkSkillFiles =
    ...
    builtins.listToAttrs (
      lib.concatMap (c: [
        {
          name = ".gemini/skills/${c.name}/SKILL.md";
          value = {
            inherit (c) source;
            force = true;
          };
...
in
{
  config = lib.mkIf cfg.enable {
    home.file =
      # Skills
      mkSkillFiles cfg.skills.fromFlakeInputs
      // mkLocalSkills cfg.skills.local
